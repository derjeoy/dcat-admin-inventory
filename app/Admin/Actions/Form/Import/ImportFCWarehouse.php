...
use App\Admin\Actions\Form\Import\DataExcelFCWarehouse;
use Maatwebsite\Excel\Facades\Excel;
use Maatwebsite\Excel\Validators\ValidationException;

class ImportFCWarehouse extends Form
{
    public function handle(array $input)
    {
        ...
        try {
            Excel::import(new DataExcelFCWarehouse(time()), $input['file'],'public');
				//dcat-2.0版本写法
